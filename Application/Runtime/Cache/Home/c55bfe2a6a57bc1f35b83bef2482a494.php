...
<div class="admin-content" >
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加读者信息</strong> / <small>Add Reader</small></div>
    </div>
        ...
        <form class="am-form am-form-horizontal" method="post" action="<?php echo ($action); ?>">
          ...
          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <input type="submit" value="确认添加"class="am-btn am-btn-primary" />
            </div>
          </div>
        </form>
      </div>
